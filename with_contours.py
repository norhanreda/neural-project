...
for sub_dir in os.listdir(dataset_dir):
    ...
    for file_name in os.listdir(sub_dir_path):
        ...
        # contour_features.append(area)
        # perimeter = cv2.arcLength(contour, True)
        # contour_features.append(perimeter)
        ...
        # contour_features.append(hull_area)
        # solidity = float(area) / hull_area
        # contour_features.append(solidity)

        # # Calculate extent
        # rect_area = w * h
        # contour_features.append(rect_area)
        ...
        # print(contour_features)
        features.append(defects.flatten)
        print(sub_dir)
